...
<span class="line"><span class="token comment">#     End</span></span>
<span class="line"></span></code></pre></div><br><h3 id="join阻塞线程" tabindex="-1"><a class="header-anchor" href="#join阻塞线程"><span>join阻塞线程</span></a></h3><p>如果想让所有线程工作完毕后，主线程再执行代码，此时可以使用<code>线程.join()</code>来等待线程执行完毕</p><p>join作用</p><ul><li>阻塞线程直到执行完毕</li><li>它还可以设置超时时间，当超过超时时间，不管线程是否执行完毕，都会向下执行</li><li><code>join</code>无视<code>daemon</code>的值</li></ul><p>将<code>daemon</code>代码改造一下，使代码最后再输出<code>End</code></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">from</span> threading <span class="token keyword">import</span> Thread<span class="token punctuation">,</span> current_thread</span>
...
<span class="line"></span></code></pre></div><br><h3 id="event应用-延迟器-timer" tabindex="-1"><a class="header-anchor" href="#event应用-延迟器-timer"><span>Event应用 - 延迟器 Timer</span></a></h3><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> logging</span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,644)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1767346944000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"1835363399@qq.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"4dfb3d791dfed965ed30fd1cc54ec3166471f1b8","time":1767346944000,"email":"1835363399@qq.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
