import{_ as s,c as a,a as p,o as t}from"./app-Chm5rEPw.js";const e={};function o(c,n){return t(),a("div",null,[...n[0]||(n[0]=[p(`<h1 id="python" tabindex="-1"><a class="header-anchor" href="#python"><span>Python</span></a></h1><p>已经编译好的包下载：<a href="https://www.piwheels.org/" target="_blank" rel="noopener noreferrer">https://www.piwheels.org/</a></p><br><h2 id="一、python解释器" tabindex="-1"><a class="header-anchor" href="#一、python解释器"><span>一、Python解释器</span></a></h2><p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/tutorial/interpreter.html" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/tutorial/interpreter.html</a></p><h3 id="解释器的多种实现" tabindex="-1"><a class="header-anchor" href="#解释器的多种实现"><span>解释器的多种实现</span></a></h3><p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/reference/introduction.html#implementations" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/reference/introduction.html#implementations</a></p><p>CPython</p><p>这是最早出现并持续维护的 Python 实现，以 C 语言编写。新的语言特性通常在此率先添加。</p><p>平常使用的就是CPython</p><p>Jython</p><p>以 Java 语言编写的 Python 实现。此实现可以作为 Java 应用的一个脚本语言，或者可以用来创建需要 Java 类库支持的应用。想了解更多信息可访问 <a href="http://www.jython.org/" target="_blank" rel="noopener noreferrer">Jython 网站</a></p><p>Python for .NET</p><p>此实现实际上使用了 CPython 实现，但是属于 .NET 托管应用并且可以引入 .NET 类库。它的创造者是 Brian Lloyd。想了解详情可访问 <a href="https://pythonnet.github.io/" target="_blank" rel="noopener noreferrer">Python for .NET 主页</a></p><p>IronPython</p><p>另一个 .NET 的 Python 实现，与 Python.NET 不同点在于它是生成 IL 的完全 Python 实现，并且将 Python 代码直接编译为 .NET 程序集。它的创造者就是当初创造 Jython 的 Jim Hugunin。想了解详情可访问 <a href="http://ironpython.net/" target="_blank" rel="noopener noreferrer">IronPython 网站</a></p><p>PyPy</p><p>完全使用 Python 语言编写的 Python 实现。它支持多个其他实现所没有的高级特性，例如非栈式支持和 JIT 编译器等。此项目的目标之一是通过允许方便地修改解释器 (因为它是用 Python 编写的)，鼓励该对语言本身进行试验。想了解详情可访问 <a href="http://pypy.org/" target="_blank" rel="noopener noreferrer">PyPy 项目主页</a></p><p>总结</p><table><thead><tr><th>实现语言</th><th>解释器名称</th><th>官网</th><th>备注</th></tr></thead><tbody><tr><td>C</td><td>CPython</td><td><a href="https://www.python.org/" target="_blank" rel="noopener noreferrer">https://www.python.org/</a></td><td>官方实现</td></tr><tr><td>Python</td><td>PyPy</td><td><a href="https://www.pypy.org/" target="_blank" rel="noopener noreferrer">https://www.pypy.org/</a></td><td>Python实现</td></tr><tr><td>Java</td><td>Jython</td><td><a href="https://www.jython.org/" target="_blank" rel="noopener noreferrer">https://www.jython.org/</a></td><td>Java实现</td></tr><tr><td>.Net</td><td>Python for .NET和IronPython</td><td><a href="https://pythonnet.github.io/" target="_blank" rel="noopener noreferrer">https://pythonnet.github.io/</a><br><a href="https://ironpython.net/" target="_blank" rel="noopener noreferrer">https://ironpython.net/</a></td><td>.Net相关，但是并非完全由.Net实现</td></tr></tbody></table><h3 id="增强版交互式解释器-repl" tabindex="-1"><a class="header-anchor" href="#增强版交互式解释器-repl"><span>增强版交互式解释器（REPL）</span></a></h3><h4 id="ipython" tabindex="-1"><a class="header-anchor" href="#ipython"><span>IPython</span></a></h4><p>官网地址：<a href="https://ipython.org/" target="_blank" rel="noopener noreferrer">https://ipython.org/</a></p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 安装</span></span>
<span class="line">pip <span class="token function">install</span> ipython</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 启动</span></span>
<span class="line">ipython</span>
<span class="line"></span></code></pre></div><h4 id="jupyter-notebook" tabindex="-1"><a class="header-anchor" href="#jupyter-notebook"><span>Jupyter Notebook</span></a></h4><p>官网地址：<a href="https://jupyter.org/" target="_blank" rel="noopener noreferrer">https://jupyter.org/</a></p><p>安装</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 安装 </span></span>
<span class="line">pip <span class="token function">install</span> jupyter</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 设置密码(可选)</span></span>
<span class="line">jupyter notebook password</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 启动</span></span>
<span class="line"><span class="token comment"># 注意：--notebook-dir 指定文件目录，需提前创建；--allow-root 允许root用户运行此命令，默认不允许</span></span>
<span class="line">jupyter notebook <span class="token parameter variable">--ip</span><span class="token operator">=</span><span class="token number">127.0</span>.0.1 <span class="token parameter variable">--port</span> <span class="token number">8888</span> --notebook-dir<span class="token operator">=</span>%USERPROFILE%/Desktop/jupyter  --allow-root</span>
<span class="line"></span></code></pre></div><p>快捷键</p><table><thead><tr><th>快捷键</th><th>说明</th></tr></thead><tbody><tr><td>Enter</td><td>进入编辑模式</td></tr><tr><td>Ctrl + Enter</td><td>执行语句，并保持在当前Cell（行）</td></tr><tr><td>Shift + Enter</td><td>执行语句，并进入下一个Cell（行）</td></tr><tr><td>↑↓</td><td>上/下一个Cell（行）</td></tr></tbody></table><h3 id="版本管理" tabindex="-1"><a class="header-anchor" href="#版本管理"><span>版本管理</span></a></h3><p>主要用来再不改动代码的情况下，方便不同Python版本之间的切换</p><p>####　Pyenv</p><p>Pyenv（非Windows版本）项目地址：<a href="https://github.com/pyenv/pyenv" target="_blank" rel="noopener noreferrer">https://github.com/pyenv/pyenv</a></p><p>Pyenv-Win(Windows版本) 项目地址：<a href="https://github.com/pyenv-win/pyenv-win" target="_blank" rel="noopener noreferrer">https://github.com/pyenv-win/pyenv-win</a></p><p>Pyenv安装</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># windows cmd命令行安装</span></span>
<span class="line"><span class="token number">1</span>.cmd执行</span>
<span class="line">pip <span class="token function">install</span> pyenv-win <span class="token parameter variable">--target</span> %USERPROFILE%<span class="token punctuation">\\</span>.pyenv  <span class="token comment"># %USERPROFILE%为用户配置文件目录，一般情况下和用户家目录相同</span></span>
<span class="line"></span>
<span class="line"><span class="token number">2</span>.PowerShell执行</span>
<span class="line"><span class="token punctuation">[</span>System.Environment<span class="token punctuation">]</span>::SetEnvironmentVariable<span class="token punctuation">(</span><span class="token string">&#39;PYENV&#39;</span>,<span class="token variable">$env</span>:USERPROFILE + <span class="token string">&quot;\\.pyenv\\pyenv-win<span class="token entity" title="\\&quot;">\\&quot;</span>,&quot;</span>User<span class="token string">&quot;)</span>
<span class="line">[System.Environment]::SetEnvironmentVariable(&#39;PYENV_HOME&#39;,<span class="token variable">$env</span>:USERPROFILE + &quot;</span><span class="token punctuation">\\</span>.pyenv<span class="token punctuation">\\</span>pyenv-win<span class="token punctuation">\\</span>&quot;,<span class="token string">&quot;User&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token number">3</span>.PowerShell执行</span>
<span class="line"><span class="token punctuation">[</span>System.Environment<span class="token punctuation">]</span>::SetEnvironmentVariable<span class="token punctuation">(</span><span class="token string">&#39;path&#39;</span>, <span class="token environment constant">$HOME</span> + <span class="token string">&quot;\\.pyenv\\pyenv-win<span class="token entity" title="\\b">\\b</span>in;&quot;</span> + <span class="token environment constant">$HOME</span> + <span class="token string">&quot;\\.pyenv\\pyenv-win\\shims;&quot;</span> + <span class="token variable">$env</span>:Path,<span class="token string">&quot;User&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token number">4</span>.检查是否安装成功</span>
...
<span class="line">pyenv <span class="token number">2.64</span>.3</span>
<span class="line"></span></code></pre></div><p>Pyenv命令</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 查看所有可安装版本</span></span>
...
<span class="line"></span></code></pre></div><h3 id="全局解释器锁gil" tabindex="-1"><a class="header-anchor" href="#全局解释器锁gil"><span>全局解释器锁GIL</span></a></h3><h4 id="gil是什么" tabindex="-1"><a class="header-anchor" href="#gil是什么"><span>GIL是什么？</span></a></h4><p>GIL，全称为Global Interpreter Lock，中文翻译为全局解释器锁，属于互斥锁，</p><p>简单来说就是给Python解释器上了一把锁，同一时刻只允许同时一个线程执行代码，同一时刻只能利用单核CPU，</p><p>这就导致Python的多线程并非是真正的多线程</p><h4 id="gil的优点" tabindex="-1"><a class="header-anchor" href="#gil的优点"><span>GIL的优点</span></a></h4><p>CPython使用引用计数作为垃圾回收器的内存管理技术，工作原理如下：</p><p>1.每个对象都有一个引用计数，</p><p>2.当对象被赋给一个新的变量名或被添加到一个容器(如元组、列表等)时，引用计数会增加，</p><p>​ 同样，当引用超出范围或调用del语句时，引用计数也会减少</p><p>3.当一个对象的引用计数达到0时，它将被垃圾回收，分配的内存将被释放</p><p>在多线程下引用计数变量需要被保护（因为赋值等操作是非原子的），此时有两种解决办法：</p><p>（1）给每个对象添加一个锁，这可能 增加死锁的可能性，并且性能开销较大</p><p>（2）添加全局解释器锁，只有一把锁，管理简单，且开销较小</p><h4 id="gil的缺点" tabindex="-1"><a class="header-anchor" href="#gil的缺点"><span>GIL的缺点</span></a></h4><p>GIL导致Python无法真正的使用多核CPU资源，无法真正并行</p><p>总结</p><p>CPU密集型任务不适合多线程，相比单线程反而会降低效率，此时可以使用多进程代替</p><p>IO密集型任务可以使用多线程</p><p>参考资料</p><p>官方Wiki：<a href="https://wiki.python.org/moin/GlobalInterpreterLock" target="_blank" rel="noopener noreferrer">https://wiki.python.org/moin/GlobalInterpreterLock</a></p><h3 id="常用选项及环境变量" tabindex="-1"><a class="header-anchor" href="#常用选项及环境变量"><span>常用选项及环境变量</span></a></h3><p>官方文档：<a href="https://docs.python.org/zh-cn/3.9/using/cmdline.html#using-on-general" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3.9/using/cmdline.html#using-on-general</a></p><h4 id="c-command-执行python代码" tabindex="-1"><a class="header-anchor" href="#c-command-执行python代码"><span>-c &lt;command&gt; 执行Python代码</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">python <span class="token parameter variable">-c</span> <span class="token string">&quot;import sys;print(&#39;.&#39;.join([str(x) for x in sys.version_info[:3]]))&quot;</span></span>
<span class="line"><span class="token number">3.9</span>.2</span>
<span class="line"></span></code></pre></div><h4 id="m-module-name-执行模块代码" tabindex="-1"><a class="header-anchor" href="#m-module-name-执行模块代码"><span>-m &lt;module-name&gt; 执行模块代码</span></a></h4><p>执行模块中<code>if __name__ == &#39;__main__&#39;:</code>下面的内容</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 示例1 - 开启http server</span></span>
...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div><h4 id="b-在导入模块时不生成-pyc文件" tabindex="-1"><a class="header-anchor" href="#b-在导入模块时不生成-pyc文件"><span>-B 在导入模块时不生成.pyc文件</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># pyc_test.py</span></span>
...
<span class="line">PYTHONDONTWRITEBYTECODE</span>
<span class="line">此变量如果被设为一个非空字符串，Python 将不会尝试在导入源模块时写入 <span class="token punctuation">.</span>pyc 文件。 这相当于指定 <span class="token operator">-</span>B 选项。</span>
<span class="line"></span></code></pre></div><h4 id="u-禁用缓冲区" tabindex="-1"><a class="header-anchor" href="#u-禁用缓冲区"><span>-u 禁用缓冲区</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># test.py</span></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 环境变量参考</span></span>
<span class="line">PYTHONUNBUFFERED</span>
<span class="line">此变量如果被设为一个非空字符串，它就相当于指定 <span class="token operator">-</span>u 选项。</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 总结</span></span>
<span class="line">命令行中一般为行缓冲区，Jenkins中经过测试为全缓冲区，要达到实时输出，都可以使用python <span class="token operator">-</span>u参数来达到效果</span>
<span class="line"></span></code></pre></div><h4 id="w-args-警告控制" tabindex="-1"><a class="header-anchor" href="#w-args-警告控制"><span>-w args 警告控制</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># warn_test.py</span></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 环境变量参考 </span></span>
<span class="line">PYTHONWARNINGS</span>
<span class="line">此变量等价于 <span class="token parameter variable">-W</span> 选项。 如果被设为一个以逗号分隔的字符串，它就相当于多次指定 -W，列表中后出现的过滤器优先级会高于列表中先出现的。</span>
<span class="line"></span>
<span class="line"><span class="token comment"># 还可以在代码中设置 warnings.filterwarnings(&quot;ignore&quot;)来关闭警告</span></span>
<span class="line"></span>
<span class="line">更细致的控制请参考官方文档</span>
<span class="line"></span></code></pre></div><h4 id="x-跳过第一行内容" tabindex="-1"><a class="header-anchor" href="#x-跳过第一行内容"><span>-x 跳过第一行内容</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># test.py</span></span>
...
<span class="line"></span></code></pre></div><h4 id="e-忽略所有-python-环境变量" tabindex="-1"><a class="header-anchor" href="#e-忽略所有-python-环境变量"><span>-E 忽略所有 <code>PYTHON*</code> 环境变量</span></a></h4><h4 id="q-在交互模式下也不显示版权和版本信息" tabindex="-1"><a class="header-anchor" href="#q-在交互模式下也不显示版权和版本信息"><span>-q 在交互模式下也不显示版权和版本信息</span></a></h4><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">C:<span class="token punctuation">\\</span>Users<span class="token punctuation">\\</span>VVFock3r<span class="token operator">&gt;</span>python <span class="token parameter variable">-q</span></span>
...
<span class="line"></span></code></pre></div><h2 id="" tabindex="-1"><a class="header-anchor" href="#"><span></span></a></h2><h3 id="脚本加载虚拟环境并执行代码" tabindex="-1"><a class="header-anchor" href="#脚本加载虚拟环境并执行代码"><span>脚本加载虚拟环境并执行代码</span></a></h3><details class="hint-container details"><summary>Windows .bat脚本</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">@echo off</span>
<span class="line"></span>
<span class="line">:: 进入项目根目录</span>
<span class="line"><span class="token builtin class-name">cd</span> /D D:<span class="token punctuation">\\</span>person<span class="token punctuation">\\</span>xxx</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><p>输出结果</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> 测试1: 在全局使用3个函数, 效果是一样的</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> True</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> 测试2: 在函数内部, locals<span class="token punctuation">(</span><span class="token punctuation">)</span>和vars<span class="token punctuation">(</span><span class="token punctuation">)</span>效果是一样的, 他俩和global<span class="token punctuation">(</span><span class="token punctuation">)</span>是不一样的</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> True</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> False</span>
...
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">10</span>:53:24,984	 <span class="token punctuation">[</span>MainThread, <span class="token number">291696</span><span class="token punctuation">]</span> True</span>
<span class="line"></span></code></pre></div><h3 id="列表-list" tabindex="-1"><a class="header-anchor" href="#列表-list"><span>列表(list)</span></a></h3><p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#list" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#list</a></p><p><strong>列表推导式</strong></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line">x <span class="token operator">=</span> <span class="token punctuation">[</span>x <span class="token keyword">for</span> x <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">]</span></span>
...
<span class="line">test2<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div></details><p>输出结果</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:28,170	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span> <span class="token punctuation">[</span><span class="token punctuation">]</span>和list<span class="token punctuation">(</span><span class="token punctuation">)</span>效率对比<span class="token punctuation">(</span>运行100万次时间总和<span class="token punctuation">)</span></span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:28,185	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span>          <span class="token punctuation">[</span><span class="token punctuation">]</span>: <span class="token number">0.0168023</span>秒</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:28,248	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span>      list<span class="token punctuation">(</span><span class="token punctuation">)</span>: <span class="token number">0.0661798</span>秒</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:28,248	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span> append与insert效率对比<span class="token punctuation">(</span>列表插入10万个数据,运行10次的时间总和<span class="token punctuation">)</span></span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:28,310	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span>      append: <span class="token number">0.06255819999999998</span>秒</span>
<span class="line"><span class="token number">2022</span>-04-05 <span class="token number">11</span>:34:47,223	 <span class="token punctuation">[</span>MainThread, <span class="token number">295460</span><span class="token punctuation">]</span>      insert: <span class="token number">18.904270200000003</span>秒</span>
<span class="line"></span></code></pre></div><h3 id="元组-tuple" tabindex="-1"><a class="header-anchor" href="#元组-tuple"><span>元组(tuple)</span></a></h3><p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#tuple" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#tuple</a></p><p><strong>元祖方法</strong></p><table><thead><tr><th>分类</th><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>查找</td><td><code>index(value, start=0, stop=9223372036854775807, /)</code></td><td>返回value在元组中第一次出现的索引号，找不到抛出ValueError异常</td></tr><tr><td></td><td><code>count(value, /)</code></td><td>返回value在元组中出现的次数</td></tr></tbody></table><p><strong>高级数据结构：命名元组</strong></p><p>命名元组函数签名</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line">namedtuple<span class="token punctuation">(</span>typename<span class="token punctuation">,</span> field_names<span class="token punctuation">,</span> <span class="token operator">*</span><span class="token punctuation">,</span> rename<span class="token operator">=</span><span class="token boolean">False</span><span class="token punctuation">,</span> defaults<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> module<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><p>命名元组示例</p><details class="hint-container details"><summary>点击查看完整代码</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><h3 id="字符串-str" tabindex="-1"><a class="header-anchor" href="#字符串-str"><span>字符串(str)</span></a></h3><p>文档：<a href="https://docs.python.org/3/library/stdtypes.html#str" target="_blank" rel="noopener noreferrer">https://docs.python.org/3/library/stdtypes.html#str</a></p><p><strong>（1）字符串类签名</strong></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">class</span> <span class="token class-name">str</span><span class="token punctuation">(</span><span class="token builtin">object</span><span class="token operator">=</span><span class="token string">b&#39;&#39;</span><span class="token punctuation">,</span> encoding<span class="token operator">=</span><span class="token string">&#39;utf-8&#39;</span><span class="token punctuation">,</span> errors<span class="token operator">=</span><span class="token string">&#39;strict&#39;</span><span class="token punctuation">)</span></span>
...
<span class="line"></span></code></pre></div><h3 id="字典-dict" tabindex="-1"><a class="header-anchor" href="#字典-dict"><span>字典(dict)</span></a></h3><p>文档：<a href="https://docs.python.org/zh-cn/3/library/stdtypes.html#dict" target="_blank" rel="noopener noreferrer">https://docs.python.org/zh-cn/3/library/stdtypes.html#dict</a></p><p><strong>字典创建</strong></p><details class="hint-container details"><summary>点击查看完整代码</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><p>输出结果</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span> 普通方式创建的字典: True</span>
...
<span class="line"></span></code></pre></div><h3 id="可变对象和不可变对象" tabindex="-1"><a class="header-anchor" href="#可变对象和不可变对象"><span>可变对象和不可变对象</span></a></h3><p><strong>引用计数模型</strong></p><p><img src="https://tuchuang-1257805459.cos.accelerate.myqcloud.com/698051107556314373.png" alt="698051107556314373"></p><p>代码示例</p><details class="hint-container details"><summary>点击查看完整代码和输出结果</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> sys</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><p>💡 不同Python版本对于一些细节处理并不一致，了解即可</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> sys</span>
<span class="line"></span>
...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&#39;----------------------------------------------------------------------------------------------------&#39;</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><p>关于Python更多“神奇”的操作，可以参考 <a href="https://github.com/robertparley/wtfpython-cn" target="_blank" rel="noopener noreferrer">https://github.com/robertparley/wtfpython-cn</a></p><p><strong>嵌套问题</strong></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p><strong>关于哈希</strong></p><ul><li>可哈希 == 不可变对象</li><li>不可哈希 == 可变对象</li></ul><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*- coding:utf-8 -*-</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 测试</span></span>
...
<span class="line"></span></code></pre></div><p><strong>深浅拷贝</strong></p><p>浅拷贝</p><p>说明：拷贝后仅仅是最顶层开辟了新的空间，里层的元素内存地址还是一样的</p><p>方法：各类对象(list<code>/dict</code>)等的copy方法、对象[::]、copy.copy方法</p><p>深拷贝</p><p>说明：除了顶层拷贝还对子元素也进行了拷贝（本质上递归浅拷贝），两个元素真正意义上的互不影响</p><p>方法：copy.deepcopy()</p><h3 id="基本数据类型对比" tabindex="-1"><a class="header-anchor" href="#基本数据类型对比"><span><strong>基本数据类型对比</strong></span></a></h3><table><thead><tr><th>数据类型</th><th>(容器内的)元素是否有顺序</th><th>是否是可变对象</th><th>值或KEY是否允许重复</th></tr></thead><tbody><tr><td>数字</td><td>✔</td><td>❌</td><td>✔</td></tr><tr><td>布尔值</td><td>✔</td><td>❌</td><td>✔</td></tr><tr><td>列表</td><td>✔</td><td>✔</td><td>✔</td></tr><tr><td>元祖</td><td>✔</td><td>❌</td><td>✔</td></tr><tr><td>字符串</td><td>✔</td><td>❌</td><td>✔</td></tr><tr><td>字节序列(bytes)</td><td>✔</td><td>❌</td><td>✔</td></tr><tr><td>字节数组(bytesarray)</td><td>✔</td><td>✔</td><td>✔</td></tr><tr><td>字典</td><td>✔</td><td>✔</td><td>❌</td></tr><tr><td>集合</td><td>❌</td><td>✔</td><td>❌</td></tr><tr><td>不可变集合</td><td>❌</td><td>❌</td><td>❌</td></tr></tbody></table><h2 id="-1" tabindex="-1"><a class="header-anchor" href="#-1"><span></span></a></h2><h2 id="三、函数" tabindex="-1"><a class="header-anchor" href="#三、函数"><span>三、函数</span></a></h2><h3 id="函数说明" tabindex="-1"><a class="header-anchor" href="#函数说明"><span>函数说明</span></a></h3><p>使用<code>def</code>定义函数，<code>return</code>指定返回值，若没有指定返回值，会隐式返回<code>return None</code>，举例说明</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="函数参数" tabindex="-1"><a class="header-anchor" href="#函数参数"><span>函数参数</span></a></h3><h4 id="常见形式和坑" tabindex="-1"><a class="header-anchor" href="#常见形式和坑"><span>常见形式和坑</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="可变参数和不可变参数" tabindex="-1"><a class="header-anchor" href="#可变参数和不可变参数"><span>可变参数和不可变参数</span></a></h4><p><code>*args</code>和<code>**kwargs</code>表示可变参数，在函数内部args是一个元祖，kwargs是一个字典</p><p>这两个参数不传递的话就使用默认值，即空元祖和空字典</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="仅限位置形参-positional-only-和仅限关键字形参-keyword-only" tabindex="-1"><a class="header-anchor" href="#仅限位置形参-positional-only-和仅限关键字形参-keyword-only"><span>仅限位置形参(positional-only)和仅限关键字形参(keyword-only)</span></a></h4><p>仅限位置形参就是说只能使用<code>add(1,2)</code>这种形式来传递参数，</p><p>仅限关键字形参就是只能使用<code>add(x=1, y=2)</code>来调用参数（顺序可任意调整）</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="看一个比较复杂的函数定义" tabindex="-1"><a class="header-anchor" href="#看一个比较复杂的函数定义"><span>看一个比较复杂的函数定义</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="函数作用域和legb" tabindex="-1"><a class="header-anchor" href="#函数作用域和legb"><span>函数作用域和<code>LEGB</code></span></a></h3><h4 id="作用域" tabindex="-1"><a class="header-anchor" href="#作用域"><span>作用域</span></a></h4><ul><li><p>函数内部定义的变量为 局部变量，在函数外部不能直接使用</p></li><li><p>函数内部可以使用 全局变量，但是具有只读属性，如果需要修改 需要先使用<code>global 变量名</code>，否则会报错</p><p><code>UnboundLocalError: local variable &#39;x&#39; referenced before assignment</code></p></li><li><p>如果函数<code>fn1</code>内定义一个函数<code>fn2</code>，那么</p><ul><li><code>fn2</code>对全局变量和<code>fn1</code>中的变量具有只读属性</li><li><code>f2</code>要修改全局变量使用<code>global 变量名</code></li><li><code>f2</code>要修改<code>f1</code>变量要使用<code>nonlocal 变量名</code></li><li>如果<code>f2</code>中继续嵌套函数，那么规则与上述类似</li></ul></li></ul><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 定义全局变量</span></span>
...
<span class="line"></span></code></pre></div><p>上面代码会报错<code>UnboundLocalError: local variable &#39;x&#39; referenced before assignment</code>，这是什么鬼呢？</p><p>因为函数在定义之后，未调用之前，Python解释器就知道了<code>print(x)</code>中x用的是函数内部的x，因为第二行定义了<code>x=100</code>，</p><p>但是由于是先使用后定义，那就肯定会报错了，所以我们需要注意，如果函数内部要定义变量的话，一定要先定义再使用，当然了，函数外部也是先定义再使用</p><h4 id="思考题-加深理解" tabindex="-1"><a class="header-anchor" href="#思考题-加深理解"><span>思考题-加深理解</span></a></h4><p>请思考这个是为什么？，如果不明白可以随时联系我</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">outer</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line">fn2<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 函数已经调用过了</span></span>
<span class="line">fn2<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment"># 函数已经调用过了</span></span>
<span class="line"></span></code></pre></div><h4 id="变量搜索顺序legb" tabindex="-1"><a class="header-anchor" href="#变量搜索顺序legb"><span>变量搜索顺序<code>LEGB</code></span></a></h4><ul><li><code>Local</code> 本地作用域</li><li><code>Enclosing</code> 嵌套函数的外部函数的命名空间</li><li><code>Global</code> 全局作用域</li><li><code>Build-in</code> 内置模块命名空间</li></ul><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
...
<span class="line"></span></code></pre></div><h3 id="函数签名" tabindex="-1"><a class="header-anchor" href="#函数签名"><span>函数签名</span></a></h3><p>函数签名，说白了就是描述函数参数的东西，除了写框架、调试器等，基本上我们也用不到</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="内置函数" tabindex="-1"><a class="header-anchor" href="#内置函数"><span>内置函数</span></a></h3><p>参考 <a href="https://docs.python.org/zh-cn/3/library/functions.html" target="_blank" rel="noopener noreferrer">https:<code>//docs</code>.python.org<code>/zh-cn/3/library/functions</code>.html</a></p><h3 id="内置函数库-functools" tabindex="-1"><a class="header-anchor" href="#内置函数库-functools"><span>内置函数库 <code>functools</code></span></a></h3><h4 id="reduce" tabindex="-1"><a class="header-anchor" href="#reduce"><span>reduce</span></a></h4><p>用传给 reduce 中的函数 function（有两个参数）先对集合中的第 1、2 个元素进行操作，</p><p>得到的结果再与第三个数据用 function 函数运算，最后得到一个结果</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="partial" tabindex="-1"><a class="header-anchor" href="#partial"><span>partial</span></a></h4><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> functools <span class="token keyword">import</span> partial</span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token comment"># @functools.wraps()              # 参考装饰器部分</span></span>
<span class="line"><span class="token comment"># functools.update_wrapper()      # 参考装饰器部分</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># partial 偏函数，输入一个函数和该函数的参数，并固定下来返回一个新函数; 和柯里化很相似，是不是</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">add</span><span class="token punctuation">(</span>x<span class="token punctuation">,</span> y<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token keyword">return</span> x <span class="token operator">+</span> y</span>
<span class="line"></span>
...
<span class="line">new2 <span class="token operator">=</span> partial<span class="token punctuation">(</span>add<span class="token punctuation">,</span> x<span class="token operator">=</span><span class="token number">1</span><span class="token punctuation">)</span>  <span class="token comment"># 返回一个新函数</span></span>
<span class="line"></span>
...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>new2<span class="token punctuation">(</span>y<span class="token operator">=</span><span class="token number">2</span><span class="token punctuation">)</span><span class="token punctuation">)</span>  <span class="token comment"># 3</span></span>
<span class="line"></span></code></pre></div><h4 id="partialmethod" tabindex="-1"><a class="header-anchor" href="#partialmethod"><span>partialmethod</span></a></h4><p>和partial类似，partial用于普通函数，<code>partialmethod</code>用于类方法</p><h4 id="cached-property" tabindex="-1"><a class="header-anchor" href="#cached-property"><span>cached_property</span></a></h4><p>计算过后便被缓存</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line">    <span class="token keyword">def</span> <span class="token function">test</span><span class="token punctuation">(</span>self<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>t<span class="token punctuation">.</span>test<span class="token punctuation">)</span>  <span class="token comment"># 0.0832563719467786</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>t<span class="token punctuation">.</span>test<span class="token punctuation">)</span>  <span class="token comment"># 0.0832563719467786</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>t<span class="token punctuation">.</span>test <span class="token operator">==</span> t<span class="token punctuation">.</span>test<span class="token punctuation">)</span>  <span class="token comment"># True</span></span>
<span class="line"></span></code></pre></div><h4 id="lru-cache" tabindex="-1"><a class="header-anchor" href="#lru-cache"><span>lru_cache</span></a></h4><ul><li>lru是什么？LRU是Least Recently Used的缩写，即最近最少使用，是一种常用的页面置换算法</li><li>函数签名：lru_cache(maxsize=128, typed=False)</li><li>maxsize代表最大可以缓存128个，如果设置为None代表禁用LRU功能，并且缓存可以无限增长，设置为2的幂时性能最好</li><li>typed 如果设置为True，则不同类型的函数参数将单独缓存，比如f(3)和f(3.0)将被分别缓存</li></ul><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="cmp-to-key" tabindex="-1"><a class="header-anchor" href="#cmp-to-key"><span>cmp_to_key</span></a></h4><p>比较函数，需传入两个值x，y，当x &gt; y时返回1，等于时返回0，否则返回-1</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line">new_nums <span class="token operator">=</span> <span class="token builtin">sorted</span><span class="token punctuation">(</span>nums<span class="token punctuation">,</span> key<span class="token operator">=</span>cmp_to_key<span class="token punctuation">(</span><span class="token keyword">lambda</span> x<span class="token punctuation">,</span> y<span class="token punctuation">:</span> y <span class="token operator">-</span> x<span class="token punctuation">)</span><span class="token punctuation">)</span></span>
<span class="line">new_nums2 <span class="token operator">=</span> <span class="token builtin">sorted</span><span class="token punctuation">(</span>nums<span class="token punctuation">,</span> key<span class="token operator">=</span>cmp_to_key<span class="token punctuation">(</span><span class="token keyword">lambda</span> x<span class="token punctuation">,</span> y<span class="token punctuation">:</span> x <span class="token operator">-</span> y<span class="token punctuation">)</span><span class="token punctuation">)</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>new_nums<span class="token punctuation">)</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>new_nums2<span class="token punctuation">)</span></span>
<span class="line"><span class="token comment"># 结果:</span></span>
<span class="line"><span class="token comment"># [34, 30, 9, 5, 3]</span></span>
<span class="line"><span class="token comment"># [3, 5, 9, 30, 34]</span></span>
<span class="line"></span></code></pre></div><h4 id="total-ordering" tabindex="-1"><a class="header-anchor" href="#total-ordering"><span>total_ordering</span></a></h4><p>类装饰器，实现其中一个： <code>__lt__()</code>, <code>__le__()</code>, <code>__gt__()</code>, <code>__ge__()</code>，自动实现剩余方法</p><p>要求此类需要实现<code>__eq__</code></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="递归函数" tabindex="-1"><a class="header-anchor" href="#递归函数"><span>递归函数</span></a></h3><ul><li><p>Python对递归深度做了限制，以保护解释器，超过限制抛出<code>RecursionError:maxinum recursion depth exceeded</code></p></li><li><p>使用<code>sys.getrecursionlimit()</code>获取递归深度，默认为<code>1000</code>；</p></li><li><p><code>使用sys.setrecursionlimit(n)设置递归深度</code>，注意不要设置的太大，否则会导致栈溢出，</p><p>报错<code>OverflowError: signed integer \`\`is</code> <code>greater than maximum</code></p></li></ul><p>一个递归+缓存版的费布那切数列</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="高阶函数" tabindex="-1"><a class="header-anchor" href="#高阶函数"><span>高阶函数</span></a></h3><p>高阶函数指的是可以将一个函数作为一个形参传递给一个函数 或 返回值是一个函数，这个函数就称为高阶函数</p><h4 id="sorted" tabindex="-1"><a class="header-anchor" href="#sorted"><span>sorted</span></a></h4><p>sorted 排序函数，key指定自定义排序规则，reverse可以反转结果，返回列表</p><p>函数签名</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token builtin">sorted</span><span class="token punctuation">(</span>iterable<span class="token punctuation">,</span> <span class="token operator">/</span><span class="token punctuation">,</span> <span class="token operator">*</span><span class="token punctuation">,</span> key<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> reverse<span class="token operator">=</span><span class="token boolean">False</span><span class="token punctuation">)</span></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 自定义排序规则，根据元祖索引为1的排序，或者说根据字典(元祖转为字典)的value排序</span></span>
...
<span class="line"></span></code></pre></div><h4 id="filter" tabindex="-1"><a class="header-anchor" href="#filter"><span>filter</span></a></h4><p>filter 筛选指定元素，函数可以为None时代表从序列中筛选出为真的元素，返回一个filter对象</p><p>使用filter过滤后，返回新的元素个数可能会减少</p><p>函数签名</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token builtin">filter</span><span class="token punctuation">(</span>function <span class="token keyword">or</span> <span class="token boolean">None</span><span class="token punctuation">,</span> iterable<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token builtin">filter</span> <span class="token builtin">object</span></span>
<span class="line"></span></code></pre></div><p>示例</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="装饰器" tabindex="-1"><a class="header-anchor" href="#装饰器"><span>装饰器</span></a></h3><h4 id="柯里化-currying" tabindex="-1"><a class="header-anchor" href="#柯里化-currying"><span>柯里化(Currying)</span></a></h4><p>将原来接受2个参数的函数变成新的接受一个参数的函数的过程。新的函数是接受原有函数第二个参数的函数，比如：</p><p>原函数为: <code>add(1, 2)</code></p><p>柯里化后: <code>add(1)(2)</code></p><p>柯里化简单举例</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h4 id="装饰器-1" tabindex="-1"><a class="header-anchor" href="#装饰器-1"><span>装饰器</span></a></h4><p>无参装饰器</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"></span>
...
<span class="line">        <span class="token keyword">return</span> wrapper</span>
<span class="line">    <span class="token keyword">return</span> _timer</span>
<span class="line"></span></code></pre></div><h2 id="-2" tabindex="-1"><a class="header-anchor" href="#-2"><span></span></a></h2><h2 id="四、多线程" tabindex="-1"><a class="header-anchor" href="#四、多线程"><span>四、多线程</span></a></h2><h3 id="并发和并行" tabindex="-1"><a class="header-anchor" href="#并发和并行"><span>并发和并行</span></a></h3><p>并发（Concurrent）：在同一时间点，一颗CPU核心交替做两件或多件事</p><p>并行（Parallel）：同一时间点，两颗或多颗CPU核心同时做两件或多件事</p><p>单单只看这些概念还是让人摸不着头脑，我们深入理解一下：</p><ul><li><p>在只有一颗CPU核心的处理器上面是无法实现并行的，但是可以实现并发</p></li><li><p>并行是提高并发的一种手段</p></li><li><p>由于CPython特殊的GIL锁，导致CPython不能实现并行，解决办法可以使用多进程来实现并行，</p><p>也可以使用PyPy等移除掉GIL的第三方解释器来执行（这又是一个比较深的坑）</p></li></ul><h3 id="高并发解决方案" tabindex="-1"><a class="header-anchor" href="#高并发解决方案"><span>高并发解决方案</span></a></h3><p>上面我们讲的都是在编程语言范围内的并发，而在一个项目中，高并发的本质问题往往在于数据库能够承载的并发是有限的。解决高并发的关键就在于降低单库的连接数。</p><p>通常我们可以有以下几种方法：</p><ul><li>使用缓存，缓存命中便不会再去请求数据库</li><li>系统拆分，每个业务使用独立的一个数据库实例</li><li>读写分离，对同一个数据库进一步拆分，读和写分散在不同的数据库实例上</li><li>MQ削峰，服务端限速执行</li><li>限流操作，比如令牌桶等，超出则丢弃</li></ul><blockquote><p>实际情况中要根据项目的特性，是读多写少还是读少写多，综合不同的手段来达到高并发的目的</p></blockquote><h3 id="线程说明" tabindex="-1"><a class="header-anchor" href="#线程说明"><span>线程说明</span></a></h3><ul><li>线程是CPU调度的最小单元</li><li>每个可执行程序都会有一个主线程，主线程一般我们都用来做协调工作，由主线程来创建其他线程称为工作线程</li><li>线程之间数据共享</li><li>线程状态 <ul><li>就绪(Ready)：线程能够运行但是还没有开始运行，等待被调度</li><li>运行(Running)：线程一旦调度就处于运行中</li><li>阻塞(Blocked)：线程等待外部事件而无法运行，比如I<code>/O</code>等待</li><li>终止(Teminated)：线程退出</li></ul></li><li>工作线程一旦启动，不可暂停和取消，除非代码运行完成或抛出异常而停止；工作线程崩溃不影响主线程正常运行</li></ul><h3 id="cpython线程使用场景" tabindex="-1"><a class="header-anchor" href="#cpython线程使用场景"><span>CPython线程使用场景</span></a></h3><p>线程是最出名的实现并发和并行的方式之一，但是在CPython中由于GIL的存在，线程只能实现并发，而不能实现并行。</p><p>可以说CPython的线程并不是真正的线程，但是它在某些场景下仍旧可以为我们的代码提速，其原理在于：</p><ul><li>对于CPU密集型的应用，由于线程会一直霸占CPU，除非线程执行完成或主动交出控制权，所以使用多线程一般会导致程序变慢（线程创建和销毁需要开销）</li><li>对于IO密集型应用，遇到IO阻塞时系统会自动进行线程切换，所以可以极大的提高程序效率</li></ul><h3 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用"><span>基本使用</span></a></h3><p>函数形式</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>类形式</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">from</span> datetime <span class="token keyword">import</span> datetime</span>
<span class="line"><span class="token keyword">from</span> threading <span class="token keyword">import</span> Thread</span>
...
<span class="line">    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><h3 id="线程属性" tabindex="-1"><a class="header-anchor" href="#线程属性"><span>线程属性</span></a></h3><p>Thread类签名</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> group<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> target<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span> name<span class="token operator">=</span><span class="token boolean">None</span><span class="token punctuation">,</span></span>
...
<span class="line"></span>
<span class="line">targe	线程调度的函数</span>
<span class="line">name	线程名字</span>
<span class="line">args	线程函数参数，是一个元祖</span>
<span class="line">daemon	后面有讲解</span>
<span class="line"></span></code></pre></div><p>Thread实例属性和方法</p><table><thead><tr><th>属性/方法</th><th>说明</th></tr></thead><tbody><tr><td>start()</td><td>执行任务（启动新线程）,start会启动新线程然后调用run方法</td></tr><tr><td>run()</td><td>执行任务（在当前线程中），run方法会执行具体的任务</td></tr><tr><td>name/getName()</td><td>线程名，默认以Thread-1、Thread-2形式命名</td></tr><tr><td>setName()</td><td>设置线程名称</td></tr><tr><td>ident</td><td>线程ID，非0整数，线程启动后才会有ID，否则为None。线程退出，此ID依旧可以访问。此ID可以重复使用</td></tr><tr><td>is_alive()</td><td>返回线程是否还活着，等同于.isAlive()</td></tr></tbody></table><p>threading模块属性和方法</p><table><thead><tr><th>属性/方法</th><th>说明</th></tr></thead><tbody><tr><td>current_thread()</td><td>返回当前线程对象</td></tr><tr><td>get_ident()</td><td>返回当前线程的ID，非0整数</td></tr><tr><td>main_thread()</td><td>返回主线程对象</td></tr><tr><td>active_count()</td><td>当前处于alive状态的线程个数</td></tr><tr><td>enumerate()</td><td>返回所有的活着的线程列表，不包括未开始和已终止的线程</td></tr></tbody></table><h3 id="线程安全" tabindex="-1"><a class="header-anchor" href="#线程安全"><span>线程安全</span></a></h3><p>线程执行一段代码的时候，这段代码要么不执行，要么一定会执行完(执行过程中不会切换到其他线程)，这段代码就称为线程安全</p><p>（1）直接使用<code>print</code>函数是线程不安全的，但通过修改使用方式，可以达到线程安全；<code>logging</code>是线程安全，更推荐使用<code>logging</code>来代替<code>print</code></p><p><code>print</code>线程安全说明</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;hello world&quot;</span><span class="token punctuation">)</span>            <span class="token comment"># 线程不安全</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;hello world\\n&quot;</span><span class="token punctuation">,</span> end<span class="token operator">=</span><span class="token string">&quot;&quot;</span><span class="token punctuation">)</span>  <span class="token comment"># 线程安全</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 原理在于：</span></span>
<span class="line"><span class="token comment">#   (1)print(&quot;hello world&quot;)其实是两步操作，先输出hello world，再输出换行符\\n，这中间是可以被打断的</span></span>
<span class="line"><span class="token comment">#   (2)通过指定end=&quot;&quot;，等同于将第二步操作给去掉</span></span>
<span class="line"></span></code></pre></div><p>线程安全演示</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> logging</span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">thread_safe</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line">        <span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;{} is running&quot;</span><span class="token punctuation">.</span><span class="token builtin">format</span><span class="token punctuation">(</span>current_thread<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>name<span class="token punctuation">)</span><span class="token punctuation">)</span>  <span class="token comment"># 线程不安全</span></span>
<span class="line">        <span class="token comment"># print(&quot;{} is running\\n&quot;.format(current_thread().name), end=&quot;&quot;)    # 线程安全</span></span>
<span class="line">        <span class="token comment"># logging.warning(&quot;{} is running&quot;.format(current_thread().name))    # 线程安全</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">5</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    t <span class="token operator">=</span> Thread<span class="token punctuation">(</span>target<span class="token operator">=</span>thread_safe<span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><p><img src="https://tuchuang-1257805459.cos.accelerate.myqcloud.com/image-20220330204518155.png" alt="image-20220330204518155"></p><p>（2）<code>queue</code>是线程安全的，但是下面的代码是线程不安全的</p><p><code>queue</code>线程不安全原理</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">if</span> q<span class="token punctuation">.</span>qsize<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">&gt;</span> <span class="token number">0</span><span class="token punctuation">:</span></span>
...
<span class="line"><span class="token comment"># 解决办法：qsize()和get()的组合代码加锁</span></span>
<span class="line"></span></code></pre></div><p><code>queue</code>线程安全演示</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> logging</span>
<span class="line"><span class="token keyword">import</span> random</span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 线程不安全代码(未加锁)</span></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">thread_safe</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 线程安全代码(已加锁)</span></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">thread_safe2</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line"><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">100</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    Thread<span class="token punctuation">(</span>target<span class="token operator">=</span>thread_safe<span class="token punctuation">)</span><span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">    <span class="token comment"># Thread(target=thread_safe2).start()</span></span>
<span class="line"></span></code></pre></div><h3 id="daemon" tabindex="-1"><a class="header-anchor" href="#daemon"><span>daemon</span></a></h3><p>设置线程daemon为False后，当主线程执行结束后，要等待非daemon线程执行完成</p><p>设置daemon为True后，当主线程执行结束后，daemon线程也会立即退出</p><p>子线程的daemon的值从父线程中继承来，父线程如果不设置默认为False</p><p>daemon相关方法</p><table><thead><tr><th>属性</th><th>说明</th></tr></thead><tbody><tr><td>threading.Thread(...., daemon=True)</td><td>创建线程时设置daemon属性</td></tr><tr><td>线程.setDaemon(True)</td><td>线程创建完成后，也可以设置daemon属性，必须在start之前</td></tr><tr><td>线程.isDaemon()/daemon</td><td>返回daemon状态</td></tr></tbody></table><p>daemon线程应用场景</p><ul><li><p>随时可以被终止的线程</p></li><li><p>后台任务，如发送心跳包、监控；</p></li><li><p>主线程工作才有用的线程，如主线程维护这公共资源，主线程已经清理了，准备退出，而工作线程使用这些资源已经没有意义了，一起退出最合适</p></li></ul><p>daemon示例</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">from</span> threading <span class="token keyword">import</span> Thread<span class="token punctuation">,</span> current_thread</span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">show_msg</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line"><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">10</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    Thread<span class="token punctuation">(</span>target<span class="token operator">=</span>show_msg<span class="token punctuation">)</span><span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment"># 未设置daemon属性，默认继承夫线程，默认为False</span></span>
<span class="line">    <span class="token comment"># Thread(target=show_msg, daemon=True).start()  # 设置daemon属性</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 未设置daemon时，输出结果：</span></span>
...
<span class="line"><span class="token comment">#     End</span></span>
<span class="line"></span></code></pre></div><h3 id="join阻塞线程" tabindex="-1"><a class="header-anchor" href="#join阻塞线程"><span>join阻塞线程</span></a></h3><p>如果想让所有线程工作完毕后，主线程再执行代码，此时可以使用<code>线程.join()</code>来等待线程执行完毕</p><p>join作用</p><ul><li>阻塞线程直到执行完毕</li><li>它还可以设置超时时间，当超过超时时间，不管线程是否执行完毕，都会向下执行</li><li><code>join</code>无视<code>daemon</code>的值</li></ul><p>将<code>daemon</code>代码改造一下，使代码最后再输出<code>End</code></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">from</span> threading <span class="token keyword">import</span> Thread<span class="token punctuation">,</span> current_thread</span>
...
<span class="line"><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">10</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    t <span class="token operator">=</span> Thread<span class="token punctuation">(</span>target<span class="token operator">=</span>show_msg<span class="token punctuation">,</span> daemon<span class="token operator">=</span><span class="token boolean">True</span><span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
...
<span class="line"></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;End&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><h3 id="线程锁" tabindex="-1"><a class="header-anchor" href="#线程锁"><span>线程锁</span></a></h3><p>Lock相关类：</p><ul><li><p>Lock：独占锁或叫做互斥锁，同一时间只有一个线程能获取到锁</p></li><li><p>RLock：可重入锁，同一时间只有一个线程能获取到锁，在同一个线程内可多次acquire()，但也需要执行相同次数的release()</p></li></ul><p>lock实例方法</p><table><thead><tr><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>acquire(blocking, timeout)</td><td>尝试获取锁，获取成功返回True，获取失败的话：<br>（1）默认会一直阻塞<br>（2）如果指定blocking为False，直接返回False，表示获取锁失败<br>（3）如果指定了timeout，那么超时以后返回False</td></tr><tr><td>release()</td><td>释放锁</td></tr><tr><td>locked()</td><td>查看是否上锁，已上锁返回True，否则返回False（注意RLOCK实例没有这个方法）</td></tr></tbody></table><p>死锁和RLOCK</p><p>连续两次acquire请求会导致死锁，因为第一次获得锁之后还没有释放时，第二次acquire请求紧接着就到来，</p><p>但是acquire会让程序阻塞，无法执行release()，这就导致锁永远无法释放，就像下面这样</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line">Lock<span class="token punctuation">.</span>acquire<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
...
<span class="line">Lock<span class="token punctuation">.</span>release<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><p>RLock就不存在上面提到的死锁问题，只需要保证有多少次acquire()，就有多少次release()即可</p><p>Lock演示</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line">        <span class="token comment"># 加锁（方式三）</span></span>
...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;End&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 未加锁输出结果：</span></span>
...
<span class="line"><span class="token comment"># End</span></span>
<span class="line"></span></code></pre></div><h3 id="线程局部变量" tabindex="-1"><a class="header-anchor" href="#线程局部变量"><span>线程局部变量</span></a></h3><p>创建一个全局变量<code>request = local()</code>，使用多线程对<code>request</code>进行修改时，会先将request拷贝到自身线程中一份，不会影响到全局和其他线程中的<code>request</code></p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">import</span> logging</span>
...
<span class="line">logging<span class="token punctuation">.</span>basicConfig<span class="token punctuation">(</span><span class="token builtin">format</span><span class="token operator">=</span>FORMAT<span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 初始化全局变量</span></span>
<span class="line"><span class="token comment"># class Request(object): pass</span></span>
<span class="line"><span class="token comment"># request = Request()</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 初始化线程局部变量</span></span>
<span class="line">request <span class="token operator">=</span> local<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">def</span> <span class="token function">thread_local</span><span class="token punctuation">(</span>request<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    request<span class="token punctuation">.</span>thread_name <span class="token operator">=</span> current_thread<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>getName<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">    time<span class="token punctuation">.</span>sleep<span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span></span>
<span class="line">    logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string">&#39;request.thread_name: {}&#39;</span><span class="token punctuation">.</span><span class="token builtin">format</span><span class="token punctuation">(</span>request<span class="token punctuation">.</span>thread_name<span class="token punctuation">)</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line">    Thread<span class="token punctuation">(</span>target<span class="token operator">=</span>thread_local<span class="token punctuation">,</span> args<span class="token operator">=</span><span class="token punctuation">(</span>request<span class="token punctuation">,</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">while</span> active_count<span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">&gt;</span> <span class="token number">1</span><span class="token punctuation">:</span></span>
<span class="line">    time<span class="token punctuation">.</span>sleep<span class="token punctuation">(</span><span class="token number">1</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span><span class="token string">&quot;End&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><h3 id="线程同步-事件event" tabindex="-1"><a class="header-anchor" href="#线程同步-事件event"><span>线程同步 - 事件Event</span></a></h3><p>Event是线程通信间最简单的实现，使用一个变量flag，通过flag的True或False变化来执行不同操作</p><p>Event变化会通知到所有线程</p><p>Event实例方法</p><table><thead><tr><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>set()</td><td>标记为True</td></tr><tr><td>clear()</td><td>标记为False</td></tr><tr><td>is_set()</td><td>新创建的event或使用<code>clear</code>()后为False，当设置<code>set</code>()后返回True</td></tr><tr><td>wait(timeout=None)</td><td>等待，满足以下条件后立即执行：<br>（1）当调用<code>set</code>()后立即执行，此时wait返回值为True<br>（2）当超时后立即执行，此时wait返回值为False</td></tr></tbody></table><p>Event演示</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
...
<span class="line">    <span class="token comment"># 子线程中每隔3秒循环一次，无限循环，除非主线程主动暂停，这里是一个技巧，以后可以使用</span></span>
<span class="line">    <span class="token keyword">while</span> <span class="token keyword">not</span> event<span class="token punctuation">.</span>wait<span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">        logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string">&quot;Running&quot;</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><h3 id="event应用-延迟器-timer" tabindex="-1"><a class="header-anchor" href="#event应用-延迟器-timer"><span>Event应用 - 延迟器 Timer</span></a></h3><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> logging</span>
...
<span class="line">logging<span class="token punctuation">.</span>basicConfig<span class="token punctuation">(</span><span class="token builtin">format</span><span class="token operator">=</span>FORMAT<span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 初始化条件变量</span></span>
<span class="line">condition <span class="token operator">=</span> Condition<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"><span class="token comment"># condition = Condition(Lock())</span></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 初始化全局数据</span></span>
<span class="line">data <span class="token operator">=</span> Queue<span class="token punctuation">(</span>maxsize<span class="token operator">=</span><span class="token number">3</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">class</span> <span class="token class-name">Producer</span><span class="token punctuation">(</span>Thread<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line">            <span class="token comment"># 注意：如果直接使用condition.acquire()的话不要忘记release(),</span></span>
<span class="line">            <span class="token comment">#      否则当condition = Condition(Lock())时会造成死锁，使用默认的RLock也会造成死锁，只是不容易复现</span></span>
<span class="line">            <span class="token keyword">with</span> condition<span class="token punctuation">:</span></span>
<span class="line">                <span class="token comment"># 添加数据至容器满</span></span>
<span class="line">                <span class="token keyword">while</span> <span class="token keyword">not</span> data<span class="token punctuation">.</span>full<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
...
<span class="line">                    data<span class="token punctuation">.</span>put<span class="token punctuation">(</span>item<span class="token punctuation">)</span></span>
<span class="line">                    logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string-interpolation"><span class="token string">f&quot;添加数据项: </span><span class="token interpolation"><span class="token punctuation">{</span>item<span class="token punctuation">}</span></span><span class="token string">, 当前队列大小: </span><span class="token interpolation"><span class="token punctuation">{</span>data<span class="token punctuation">.</span>qsize<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">}</span></span><span class="token string">&quot;</span></span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line">                <span class="token comment"># 通知小伙伴消费</span></span>
<span class="line">                condition<span class="token punctuation">.</span>notify<span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment"># 通知，但还未释放锁</span></span>
<span class="line">                logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string">&quot;队列已满, 通知其他线程消费&quot;</span><span class="token punctuation">)</span></span>
<span class="line">                condition<span class="token punctuation">.</span>wait<span class="token punctuation">(</span><span class="token punctuation">)</span>  <span class="token comment"># 释放锁，并进入等待模式; 被唤醒时又会重新获取锁</span></span>
<span class="line"></span>
...
<span class="line">            wrapper<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token keyword">class</span> <span class="token class-name">Consumer</span><span class="token punctuation">(</span>Thread<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    <span class="token keyword">def</span> <span class="token function">__init__</span><span class="token punctuation">(</span>self<span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">        <span class="token builtin">super</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">.</span>__init__<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line">    <span class="token keyword">def</span> <span class="token function">run</span><span class="token punctuation">(</span>self<span class="token punctuation">)</span> <span class="token operator">-</span><span class="token operator">&gt;</span> <span class="token boolean">None</span><span class="token punctuation">:</span></span>
<span class="line">        <span class="token keyword">def</span> <span class="token function">wrapper</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">            <span class="token keyword">with</span> condition<span class="token punctuation">:</span></span>
<span class="line">                <span class="token keyword">while</span> <span class="token keyword">not</span> data<span class="token punctuation">.</span>empty<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">                    item <span class="token operator">=</span> data<span class="token punctuation">.</span>get<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">                    logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string-interpolation"><span class="token string">f&quot;消费数据项: </span><span class="token interpolation"><span class="token punctuation">{</span>item<span class="token punctuation">}</span></span><span class="token string">, 当前队列大小: </span><span class="token interpolation"><span class="token punctuation">{</span>data<span class="token punctuation">.</span>qsize<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">}</span></span><span class="token string">&quot;</span></span><span class="token punctuation">)</span></span>
<span class="line">                condition<span class="token punctuation">.</span>notify<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">                logging<span class="token punctuation">.</span>warning<span class="token punctuation">(</span><span class="token string">&quot;队列已空, 通知其他线程添加\\n&quot;</span><span class="token punctuation">)</span></span>
<span class="line">                time<span class="token punctuation">.</span>sleep<span class="token punctuation">(</span><span class="token number">3</span><span class="token punctuation">)</span>  <span class="token comment"># 暂停一下，方便控制台看的清楚</span></span>
<span class="line">                condition<span class="token punctuation">.</span>wait<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line">        <span class="token keyword">while</span> <span class="token boolean">True</span><span class="token punctuation">:</span></span>
<span class="line">            wrapper<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line"></span>
<span class="line"><span class="token comment"># 创建多个生产者和消费者</span></span>
<span class="line"><span class="token keyword">for</span> i <span class="token keyword">in</span> <span class="token builtin">range</span><span class="token punctuation">(</span><span class="token number">9</span><span class="token punctuation">)</span><span class="token punctuation">:</span></span>
<span class="line">    t <span class="token operator">=</span> Producer<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>setName<span class="token punctuation">(</span><span class="token string">&quot;Producer-{}&quot;</span><span class="token punctuation">.</span><span class="token builtin">format</span><span class="token punctuation">(</span>i <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span>
<span class="line">    t <span class="token operator">=</span> Consumer<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>setName<span class="token punctuation">(</span><span class="token string">&quot;Consumer-{}&quot;</span><span class="token punctuation">.</span><span class="token builtin">format</span><span class="token punctuation">(</span>i <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span></span>
<span class="line">    t<span class="token punctuation">.</span>start<span class="token punctuation">(</span><span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div><h3 id="线程同步-barrier" tabindex="-1"><a class="header-anchor" href="#线程同步-barrier"><span>线程同步 - Barrier</span></a></h3><h3 id="线程同步-semaphore" tabindex="-1"><a class="header-anchor" href="#线程同步-semaphore"><span>线程同步 - Semaphore</span></a></h3><h3 id="线程池-threadpoolexecutor" tabindex="-1"><a class="header-anchor" href="#线程池-threadpoolexecutor"><span>线程池 - ThreadPoolExecutor</span></a></h3><p>ThreadPoolExecutor构造参数</p><table><thead><tr><th>参数</th><th>说明</th></tr></thead><tbody><tr><td>max_workers</td><td>指定线程池的最大线程数，默认为CPU核数的5倍</td></tr><tr><td>thread_name_prefix</td><td>指定线程池中线程的名称前缀</td></tr></tbody></table><p>ThreadPoolExecutor实例方法</p><table><thead><tr><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>submit(fn, *args, **kwargs)</td><td>提交任务，线程池会分配一个线程迟总任务，返回一个Future实例，如果池已经满了，还可以继续提交</td></tr><tr><td>shutdown(wait=True)</td><td>清理池，池中的线程/进程全部杀掉，同时不再接受新提交的任务，<br>如果继续提交会报错<code>RuntimeError: cannot schedule new futures after shutdown</code></td></tr></tbody></table><p>Future实例方法</p><table><thead><tr><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>done()</td><td>如果调用成功执行或取消成功，那么返回True，否则返回False</td></tr><tr><td>cancelled()</td><td>如果复用被成功的取消，那么返回True</td></tr><tr><td>running()</td><td>如果正在运行且不能被取消，那么返回True</td></tr><tr><td>cancel()</td><td>尝试取消调用，如果已经执行且不能取消返回False，否则返回True</td></tr><tr><td>result(timeout=None)</td><td>取返回的结果，timeout为None,一直等待返回，超时抛出concurrent.futures.TimeoutError异常</td></tr><tr><td>exception(timeout=None)</td><td>取返回的异常，timeout为None,一直等待返回,超时抛出concurrent.futures.TimeoutError异常</td></tr></tbody></table><p>线程池简单演示</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># -*-coding:utf-8-*-</span></span>
<span class="line"></span>
<span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">import</span> logging</span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,744)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1766325365000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"vvfock3r@gmail.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"acd435355748fe136f3e9272dee056d97f7264c8","time":1766325365000,"email":"vvfock3r@gmail.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
