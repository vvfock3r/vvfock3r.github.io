...
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>x<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>带if条件的列表推导式</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># 生成数字1-10, 并过滤出偶数</span></span>
...
<span class="line">        tmp<span class="token punctuation">.</span>append<span class="token punctuation">(</span>i<span class="token punctuation">)</span></span>
<span class="line"><span class="token keyword">print</span><span class="token punctuation">(</span>tmp<span class="token punctuation">)</span></span>
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>多层循环的列表推导式</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment"># 多层for循环</span></span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,736)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1767325918000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"1835363399@qq.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"856fe7f97de42e3eddff313854d31bd6f69ac4e3","time":1767325918000,"email":"1835363399@qq.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
