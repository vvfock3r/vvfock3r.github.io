...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>uv 使用方法</summary><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>配置文件</strong></p><ul><li><p>pyproject.toml：整个 Python 生态的&quot;标准配置文件&quot;，优先级最高，不是必须要有</p></li><li><p>.python-version：指定 Python 版本，当 <code>pyproject.toml</code> 存在时，它会被忽略</p></li><li><p>uv.lock：精确锁定所有依赖版本，自动生成，不要手写，必须和 <code>pyproject.toml</code> 配套</p></li></ul></div></details><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 给&quot;当前项目&quot;固定一个 Python 版本，类似于 pyenv local, 一般是进入项目根目录后执行此命令, 会将pin住的版本写入 .python-version</span></span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,744)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1766584990000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"vvfock3r@gmail.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"6a96630731c5a6b9379baee285b8727cd2c9abf2","time":1766584990000,"email":"vvfock3r@gmail.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
