...
<span class="line"></span></code></pre></div></details><br><h3 id="版本和依赖包管理工具-uv" tabindex="-1"><a class="header-anchor" href="#版本和依赖包管理工具-uv"><span>版本和依赖包管理工具 uv</span></a></h3><p>官网：<a href="https://docs.astral.sh/uv/" target="_blank" rel="noopener noreferrer">https://docs.astral.sh/uv/</a></p><p>Github：<a href="https://github.com/astral-sh/uv" target="_blank" rel="noopener noreferrer">https://github.com/astral-sh/uv</a></p><p>开发语言：<strong>Rust</strong></p><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>配置文件</strong></p><ul><li><p><strong>pyproject.toml</strong>：Python 生态的<strong>标准项目配置文件</strong>，用于定义项目元数据、依赖以及工具配置（包括 uv），<strong>优先级最高</strong>，但并非必须存在</p></li><li><p><strong>.python-version</strong>：用于指定项目所使用的 Python 版本，<code>uv python pin 3.14</code> 时会修改当前目录的<code>.python-version</code>，也可以手动修改。</p><p>当 <code>pyproject.toml</code> 中已声明 Python 版本时，该文件会被忽略</p></li><li><p><strong>uv.lock</strong>：用于<strong>精确锁定所有依赖版本</strong>的锁文件，由 uv <strong>自动生成和维护</strong>，不应手动编辑，必须与 <code>pyproject.toml</code> 搭配使用</p></li></ul><p><strong>注意事项</strong></p><ul><li>uv安装后的Python解释器可以直接调用，可以不经过uv，但并不易于使用</li><li>uv 管理的 Python 是&quot;只读解释器&quot;，不能做一些修改操作，比如用 <code>pip install</code> 往里面装包</li></ul></div><details class="hint-container details"><summary>安装 uv 和 uvx</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">wget</span> <span class="token parameter variable">-c</span> https://github.com/astral-sh/uv/releases/latest/download/uv-x86_64-unknown-linux-gnu.tar.gz</span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,738)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1767105657000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"vvfock3r@gmail.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"e668099066f385275ff767bfa94d2bff34d7c404","time":1767105657000,"email":"vvfock3r@gmail.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
