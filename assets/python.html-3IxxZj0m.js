...
<span class="line"></span></code></pre></div><br><h3 id="函数签名" tabindex="-1"><a class="header-anchor" href="#函数签名"><span>函数签名</span></a></h3><p>函数签名，说白了就是描述函数参数的东西，除了写框架、调试器等，基本上用不到</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"><span class="token number">2026</span>-01-02 <span class="token number">16</span>:10:53,375	 <span class="token punctuation">[</span>MainThread, <span class="token number">1864</span><span class="token punctuation">]</span> True</span>
<span class="line"></span></code></pre></div></details><br><h3 id="内置函数" tabindex="-1"><a class="header-anchor" href="#内置函数"><span>内置函数</span></a></h3><p>参考 <a href="https://docs.python.org/zh-cn/3/library/functions.html" target="_blank" rel="noopener noreferrer">https:<code>//docs</code>.python.org<code>/zh-cn/3/library/functions</code>.html</a></p><br><h3 id="内置函数库-functools" tabindex="-1"><a class="header-anchor" href="#内置函数库-functools"><span>内置函数库 <code>functools</code></span></a></h3><details class="hint-container details"><summary>（1）reduce</summary><p>用传给 reduce 中的函数 function（有两个参数）先对集合中的第 1、2 个元素进行操作，</p><p>得到的结果再与第三个数据用 function 函数运算，最后得到一个结果</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>（2）partial 和 partialmethod</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div><p>备注：partialmethod和partial类似，partial用于普通函数，<code>partialmethod</code>用于类方法</p></details><details class="hint-container details"><summary>（3）cached_property：计算过后便被缓存</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>（5）cmp_to_key：比较函数</summary><p>比较函数，需传入两个值x，y，当x &gt; y时返回1，等于时返回0，否则返回-1</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,668)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1767341886000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"1835363399@qq.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"1c0c3054f8982ed31526a65dbb9a76698c45db06","time":1767341886000,"email":"1835363399@qq.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
