...
<span class="line"></span></code></pre></div></details><br><h3 id="线程同步-阶段屏障-barrier" tabindex="-1"><a class="header-anchor" href="#线程同步-阶段屏障-barrier"><span>线程同步 - 阶段屏障 Barrier</span></a></h3><p>Barrier 用来让一组线程在某个“阶段点”集合，等所有人都到了，再一起继续往下执行。</p><p><strong>Barrier 实例化参数</strong></p><p><code>__init__(self, parties, action=None, timeout=None)</code></p><ul><li>parties：必须到齐的线程数</li><li>action：所有线程到齐时，由最后到达的线程执行的回调</li><li>timeout：全局默认超时</li></ul><p><strong>Barrier 实例方法</strong></p><table><thead><tr><th>方法</th><th>说明</th></tr></thead><tbody><tr><td>wait(timeout=None)</td><td>到达屏障并阻塞，直到所有线程到齐<br>返回值：一个整数 <code>0 ~ parties-1</code><br>最后到达的线程返回值通常为 <code>0</code><br>可用来让某个线程执行&quot;领队任务&quot;，比如 最后执行完的，负责合并结果</td></tr><tr><td>reset()</td><td>用于异常恢复或中止本轮同步<br>即让所有正在等待的线程抛 <code>BrokenBarrierError</code>，屏障恢复到初始状态，可重新使用</td></tr><tr><td>abort()</td><td>标记屏障为损坏状态<br>所有 wait 中线程立即抛异常<br>后续任何 wait 也会直接报 <code>BrokenBarrierError</code><br>必须 reset 才能恢复</td></tr><tr><td>parties</td><td>需要到达屏障的线程总数</td></tr><tr><td>n_waiting</td><td>当前正在等待中的线程数</td></tr><tr><td>broken</td><td>屏障是否已损坏</td></tr></tbody></table><details class="hint-container details"><summary>点击查看详情</summary><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token keyword">import</span> time</span>
<span class="line"><span class="token keyword">import</span> random</span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,659)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1768618244000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"1835363399@qq.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"9c873d166728408dcacfc09409d92709966124c6","time":1768618244000,"email":"1835363399@qq.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
