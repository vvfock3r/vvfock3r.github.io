...
<span class="line"><span class="token number">2026</span>-01-02 <span class="token number">16</span>:10:53,375	 <span class="token punctuation">[</span>MainThread, <span class="token number">1864</span><span class="token punctuation">]</span> True</span>
<span class="line"></span></code></pre></div></details><br><h3 id="内置函数" tabindex="-1"><a class="header-anchor" href="#内置函数"><span>内置函数</span></a></h3><p>参考 <a href="https://docs.python.org/zh-cn/3/library/functions.html" target="_blank" rel="noopener noreferrer">https:<code>//docs</code>.python.org<code>/zh-cn/3/library/functions</code>.html</a></p><br><h3 id="函数库-functools" tabindex="-1"><a class="header-anchor" href="#函数库-functools"><span>函数库 <code>functools</code></span></a></h3><details class="hint-container details"><summary>（1）reduce：把一组数据按某种规则从左到右不断累积计算，最后压缩成一个值</summary><p><code>reduce</code> 会先用传入的二元函数对集合中的第 1、2 个元素进行计算，然后将得到的结果与第 3 个元素继续用该函数运算，如此反复，最终得到一个结果</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,649)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1767934987000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"1835363399@qq.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"c003d9ce9cfe5f6523ed611b5eab914bcc7d8206","time":1767934987000,"email":"1835363399@qq.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
