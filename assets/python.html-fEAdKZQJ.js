...
<span class="line"><span class="token number">2026</span>-01-02 <span class="token number">16</span>:10:53,375	 <span class="token punctuation">[</span>MainThread, <span class="token number">1864</span><span class="token punctuation">]</span> True</span>
<span class="line"></span></code></pre></div></details><br><h3 id="内置函数" tabindex="-1"><a class="header-anchor" href="#内置函数"><span>内置函数</span></a></h3><p>参考 <a href="https://docs.python.org/zh-cn/3/library/functions.html" target="_blank" rel="noopener noreferrer">https:<code>//docs</code>.python.org<code>/zh-cn/3/library/functions</code>.html</a></p><br><h3 id="内置函数库-functools" tabindex="-1"><a class="header-anchor" href="#内置函数库-functools"><span>内置函数库 <code>functools</code></span></a></h3><details class="hint-container details"><summary>（1）reduce：把一组数据按某种规则从左到右不断累积计算，最后压缩成一个值</summary><p><code>reduce</code> 会先用传入的二元函数对集合中的第 1、2 个元素进行计算，然后将得到的结果与第 3 个元素继续用该函数运算，如此反复，最终得到一个结果</p><div class="language-python" data-highlighter="prismjs" data-ext="py"><pre><code class="language-python"><span class="line"><span class="token comment">#!/usr/bin/env python</span></span>
<span class="line"><span class="token comment"># --*-- coding:utf-8 --*--</span></span>
<span class="line"></span>
