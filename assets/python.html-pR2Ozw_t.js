...
<span class="line"></span></code></pre></div></details><br><h3 id="版本管理工具-uv" tabindex="-1"><a class="header-anchor" href="#版本管理工具-uv"><span>版本管理工具 uv</span></a></h3><p>官网：<a href="https://docs.astral.sh/uv/" target="_blank" rel="noopener noreferrer">https://docs.astral.sh/uv/</a></p><p>Github：<a href="https://github.com/astral-sh/uv" target="_blank" rel="noopener noreferrer">https://github.com/astral-sh/uv</a></p><p>开发语言：<strong>Rust</strong></p><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>配置文件说明</strong></p><ul><li><p><strong>pyproject.toml</strong>：Python 生态的<strong>标准项目配置文件</strong>，用于定义项目元数据、依赖以及工具配置（包括 uv），<strong>优先级最高</strong>，但并非必须存在</p></li><li><p><strong>.python-version</strong>：用于指定项目所使用的 Python 版本，<code>uv python pin 3.14</code> 时会修改当前目录的<code>.python-version</code>，也可以手动修改。</p><p>当 <code>pyproject.toml</code> 中已声明 Python 版本时，该文件会被忽略</p></li><li><p><strong>uv.lock</strong>：用于<strong>精确锁定所有依赖版本</strong>的锁文件，由 uv <strong>自动生成和维护</strong>，不应手动编辑，必须与 <code>pyproject.toml</code> 搭配使用</p></li></ul></div><details class="hint-container details"><summary>安装 uv 和 uvx</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">wget</span> <span class="token parameter variable">-c</span> https://github.com/astral-sh/uv/releases/latest/download/uv-x86_64-unknown-linux-gnu.tar.gz</span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>uv 安装和卸载 Python</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 查看可用的 Python 版本</span></span>
...
<span class="line">uv run python <span class="token parameter variable">-c</span> <span class="token string">&quot;import sys; print(sys.version)&quot;</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>uv 用于Python项目管理时的用法</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 初始化项目</span></span>
<span class="line"><span class="token comment"># 会在当前项目目录下创建以下文件</span></span>
...
<span class="line"><span class="token comment"># 强烈建议在一个干净的目录下执行此命令</span></span>
<span class="line">uv init                <span class="token comment"># 默认用~/.python-verion 或 本地安装的最新版本</span></span>
...
<span class="line"></span>
<span class="line"><span class="token comment"># 安装和移除依赖，不同于 uv pip install flask, 它还会额外修改 pyproject.toml 和 uv.lock</span></span>
<span class="line">uv <span class="token function">add</span> flask</span>
<span class="line">uv remove flask</span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></details><h4 id="typing-callable" tabindex="-1"><a class="header-anchor" href="#typing-callable"><span><code>typing.Callable</code></span></a></h4><p>可调用类型，<code>Callable[[int], str]</code> 是把（int）转为 str 的函数</p>`,744)])])}const i=s(e,[["render",o]]),u=JSON.parse('{"path":"/programming/language/python.html","title":"Python","lang":"zh-CN","frontmatter":{},"git":{"updatedTime":1766589180000,"contributors":[{"name":"VVFock3r","username":"VVFock3r","email":"vvfock3r@gmail.com","commits":1,"url":"https://github.com/VVFock3r"}],"changelog":[{"hash":"e5744f05ddc83f896f733f3385bd4b09f4a425c7","time":1766589180000,"email":"vvfock3r@gmail.com","author":"VVFock3r","message":"auto commit"}]},"filePathRelative":"programming/language/python.md"}');export{i as comp,u as data};
