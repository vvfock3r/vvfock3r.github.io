...
<span class="line"></span></code></pre></div></details><br><h3 id="版本管理工具-uv" tabindex="-1"><a class="header-anchor" href="#版本管理工具-uv"><span>版本管理工具 uv</span></a></h3><p>官网：<a href="https://docs.astral.sh/uv/" target="_blank" rel="noopener noreferrer">https://docs.astral.sh/uv/</a></p><p>Github：<a href="https://github.com/astral-sh/uv" target="_blank" rel="noopener noreferrer">https://github.com/astral-sh/uv</a></p><p>开发语言：<strong>Rust</strong></p><div class="hint-container tip"><p class="hint-container-title">提示</p><p><strong>配置文件说明</strong></p><ul><li><p>pyproject.toml：Python 生态的<strong>标准项目配置文件</strong>，用于定义项目元数据、依赖以及工具配置（包括 uv），<strong>优先级最高</strong>，但并非必须存在</p></li><li><p>.python-version：用于指定项目所使用的 Python 版本，<code>uv python pin 3.14</code> 时会修改当前目录的<code>.python-version</code>，也可以手动修改。 当 <code>pyproject.toml</code> 中已声明 Python 版本时，该文件会被忽略</p></li><li><p>uv.lock：用于<strong>精确锁定所有依赖版本</strong>的锁文件，由 uv <strong>自动生成和维护</strong>，不应手动编辑，必须与 <code>pyproject.toml</code> 搭配使用</p></li></ul></div><details class="hint-container details"><summary>安装uv和uvx</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token function">wget</span> <span class="token parameter variable">-c</span> https://github.com/astral-sh/uv/releases/latest/download/uv-x86_64-unknown-linux-gnu.tar.gz</span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>uv安装和卸载Python版本</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line"><span class="token comment"># 查看可用的 Python 版本</span></span>
...
<span class="line">uv venv venv                        <span class="token comment"># 建立虚拟环境 venv。 注意：推荐使用 .venv 而不是 venv</span></span>
...
<span class="line"></span></code></pre></div></details><details class="hint-container details"><summary>uv 用于Python项目管理时的用法</summary><div class="language-bash" data-highlighter="prismjs" data-ext="sh"><pre><code class="language-bash"><span class="line">uv init</span>
<span class="line">uv <span class="token function">add</span></span>
<span class="line">uv remove</span>
